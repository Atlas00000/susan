...
export function AboutBackground({ scrollYProgress }: AboutBackgroundProps = {}) {
  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <motion.div
        className="absolute top-0 left-1/4 w-[700px] h-[700px] bg-luxury-gold/8 rounded-full blur-3xl"
        animate={{
          x: [0, 90, 0],
          y: [0, 50, 0],
          scale: [1, 1.2, 1],
      ...
      <motion.div
        className="absolute bottom-0 right-1/4 w-[550px] h-[550px] bg-luxury-royal/12 rounded-full blur-3xl"
        animate={{
          x: [0, -70, 0],
          y: [0, -35, 0],
          scale: [1, 1.25, 1],
      ...
      <motion.div
        className="absolute top-1/3 left-0 w-[400px] h-[400px] bg-gradient-to-br from-luxury-gold/4 to-transparent"
        style={{
      ...
      <motion.div
        className="absolute bottom-1/4 right-0 w-[320px] h-[320px] bg-gradient-to-tl from-luxury-royal/6 to-transparent"
        style={{
