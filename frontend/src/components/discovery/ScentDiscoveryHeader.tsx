...
interface ScentDiscoveryHeaderProps {
  className?: string
}

export function ScentDiscoveryHeader({ className }: ScentDiscoveryHeaderProps) {
    ...
    >
      ...
      >
        <p>
          ...
          crafted to resonate with different aspects of your personality and lifestyle. Whether you 
          seek the depth of oud, the warmth of amber, the freshness of florals, or the boldness of 
          gourmand notes, your perfect fragrance awaits.
        </p>
        <p className="text-lg md:text-xl text-luxury-cream/60">
          Our carefully curated collections represent the finest expressions of each fragrance family, 
          sourced from renowned perfumers and artisan houses worldwide. Each scent is more than a 
          fragrance—it's a journey, a memory, a signature that becomes uniquely yours.
        </p>
      </motion.div>
    </motion.div>
  )
