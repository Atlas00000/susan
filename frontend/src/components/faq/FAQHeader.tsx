...
export function FAQHeader({ className }: FAQHeaderProps) {
  ...
  return (
    ...
    >
      ...
      >
        <p>
          Find answers to common questions about our fragrances, shipping, and more. We've 
          compiled the most frequently asked questions to help guide you through your scent 
          discovery journey with confidence and clarity.
        </p>
        <p className="text-lg md:text-xl text-luxury-cream/60">
          From understanding fragrance notes and longevity to shipping policies and care 
          instructions, our comprehensive FAQ section addresses everything you need to know. 
          If you can't find what you're looking for, our fragrance experts are always ready 
