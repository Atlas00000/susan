...
interface SimpleLuxuryMobileNavigationProps {
  className?: string
}

export function SimpleLuxuryMobileNavigation({ className }: SimpleLuxuryMobileNavigationProps) {
    ...
    <div className={cn('lg:hidden', className)}>
      ...
      >
        <div className="w-6 h-6 flex flex-col justify-center items-center space-y-1">
          <div className={`w-5 h-0.5 bg-luxury-gold rounded-full transition-all duration-300 ${
        ...
        {/* Glowing effect */}
        <div className={`absolute inset-0 rounded-xl bg-gradient-to-r from-luxury-gold/20 to-luxury-amber/20 transition-opacity duration-300 ${
      ...
      {isOpen && (
        <>
          ...
          >
            ...
            <div className="absolute top-20 right-10 w-32 h-32 bg-luxury-gold/10 rounded-full blur-3xl animate-pulse" />
            <div className="absolute bottom-20 left-10 w-24 h-24 bg-luxury-royal/15 rounded-full blur-2xl animate-pulse" />
          </motion.div>
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 bg-gradient-to-br from-luxury-gold to-luxury-amber rounded-xl flex items-center justify-center shadow-lg animate-spin">
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="text-luxury-gold group-hover:translate-x-1 transition-transform duration-300">
                          →
                        </div>
                      </Link>
                    </motion.div>
