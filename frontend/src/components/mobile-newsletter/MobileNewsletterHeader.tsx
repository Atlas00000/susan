...
interface MobileNewsletterHeaderProps {
  className?: string
}

export function MobileNewsletterHeader({ className }: MobileNewsletterHeaderProps) {
    ...
    >
      ...
      >
        <p>
          ...
          Join our community of fragrance enthusiasts and never miss a moment of luxury.
        </p>
        <p className="text-sm md:text-base text-luxury-cream/60">
          Receive curated recommendations, educational content about fragrance artistry, and be the 
          first to discover limited editions and seasonal releases.
        </p>
      </motion.div>
    </motion.div>
  )
