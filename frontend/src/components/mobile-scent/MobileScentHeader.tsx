...
interface MobileScentHeaderProps {
  className?: string
}

export function MobileScentHeader({ className }: MobileScentHeaderProps) {
  ...
  return (
    ...
    >
      ...
      >
        <p>
          Explore our curated collection and discover the scent that speaks to you. Each fragrance 
          category represents a unique olfactory journey, from the depth of oud to the freshness of florals.
        </p>
        <p className="text-sm md:text-base text-luxury-cream/60">
          Handcrafted with the finest ingredients from around the world, these scents become more 
          than fragrances—they become your signature, your confidence, your story.
        </p>
      </motion.div>
    </motion.div>
  )
